...
k=(2.0*np.pi/waveLength,0.0,0.0)
...
################
# DEBUGGING
print("WAVE STEEPNESS IS: {0}".format(epsilon))
print("AMPLITUDE IS: {0}".format(amplitude))
print("GROUP SPPED IS: {0}".format(groupVelocity))
print("WAVELENGTH IS: {0}".format(waveLength))
#sys.exit()
##############
...
T=2*period#3.00
print("Total Time of Computation is: {0}".format(T))
